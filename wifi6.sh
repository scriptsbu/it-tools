...
while true;do
  ...
  read -p "\x1b[41;37m Are you connected to TORC VPN?\x1b[K\x1b[0m" QUESTION
  
  
  case "${QUESTION}" in
    [Yy] ) 
      echo "\x1b[41;37m Uploading LOG\x1b[K\x1b[0m"
    ...
    * ) 
      echo "\x1b[41;37m Please connect to the VPN 'split push'\x1b[K\x1b[0m"
